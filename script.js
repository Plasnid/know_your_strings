...
// * the two ways you can declare variables are let and const

let personName = "Bobbert";
const placeOfBirth = 'Bobberton';
let description = `${personName} was born in ${placeOfBirth}`;
console.log(description);

let myTitle = document.querySelector("h1");
console.log(myTitle);
// * innerText or innerHTML
myTitle.innerText = description;

let isHungry = true;
myTitle.addEventListener("click",function(e){
    console.log(e);
    isHungry = !isHungry;
    if(isHungry==true){
        console.log("eat some food")
    }else{
        console.log("don't eat!  Wait for dinner!");
    }
})

// * Lots more things that strings can do!
/** 
